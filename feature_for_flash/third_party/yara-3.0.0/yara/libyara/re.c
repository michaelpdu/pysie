...
#define RE_MAX_CODE_SIZE  65536 // Maximum code size for a compiled regexp
  ...
  *code_size = 0;
  ...
  case RE_NODE_LITERAL:
    ...
    FAIL_ON_ERROR(_yr_emit_inst_arg_uint8(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_LITERAL] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_MASKED_LITERAL:
    ...
    FAIL_ON_ERROR(_yr_emit_inst_arg_uint16(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_MASKED_LITERAL] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_WORD_CHAR:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_WORD_CHAR] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_NON_WORD_CHAR:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_NON_WORD_CHAR] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_SPACE:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_SPACE] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_NON_SPACE:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_NON_SPACE] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_DIGIT:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_DIGIT] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_NON_DIGIT:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_NON_DIGIT] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_CLASS:
    ...
    *code_size += 32;
#if DEBUG
    printf("[RE_NODE_CLASS] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_ANCHOR_START:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_ANCHOR_START] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_ANCHOR_END:
    ...
    FAIL_ON_ERROR(_yr_emit_inst(
        ...
        code_size));
#if DEBUG
    printf("[RE_NODE_ANCHOR_END] CodeSize=%d\n",*code_size);
#endif
    break;
  ...
  case RE_NODE_CONCAT:
    ...
    *code_size += branch_size;
#if DEBUG
    printf("[RE_NODE_CONCAT] CodeSize=%d\n",*code_size);
#endif
...
#if DEBUG
    printf("[RE_NODE_PLUS] CodeSize=%d\n",*code_size);
#endif
...
#if DEBUG
    printf("[RE_NODE_STAR] CodeSize=%d\n",*code_size);
#endif
  ...
  case RE_NODE_RANGE:
...
#if DEBUG
    printf("[RE_NODE_RANGE] Loop Size=[%d]\n", (re_node->start));
#endif
    ...
    *code_size += inst_size;
#if DEBUG
    printf("[RE_NODE_RANGE] CodeSize=%d\n",*code_size);
#endif
    break;
  }
