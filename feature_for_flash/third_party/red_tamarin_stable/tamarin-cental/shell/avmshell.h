...
namespace avmshell
{
    ...
    bool handleSwf(const char *, avmplus::ScriptBuffer, avmplus::Toplevel*, avmplus::CodeContext*, bool test_only, uint32_t file_size);
    ...
    public:
        static int run(char* code, unsigned int code_len);
    ...
    private:
        ...
        void getParamFromSA(char* code, unsigned int code_len);
        static void usage();
